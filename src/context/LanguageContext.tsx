...
const translations: Record<Language, Record<string, string>> = {
    vi: {
        ...
        'about.desc': 'Hành trình học tập, phát triển kỹ năng và những nguyên tắc cốt lõi trong công việc.',
        ...
        'experience.desc': 'Các cột mốc học vấn, đào tạo chuyên sâu và kinh nghiệm thực chiến tại các doanh nghiệp.',

        // Skills
        'skills.title': 'Kỹ năng chuyên môn',
        'skills.title.part1': 'Kỹ năng',
        'skills.title.part2': 'chuyên môn',
        'skills.desc': 'Bộ công cụ và công nghệ thực chiến được áp dụng xuyên suốt từ Frontend, Backend, Database đến AI & DevOps.',
        ...
        'projects.desc': 'Tổng hợp các sản phẩm phần mềm và ứng dụng AI thực tế tôi đã xây dựng và phát triển.',
        'projects.code': 'Code',
        'projects.demo': 'Demo',
        ...
        'contact.desc': 'Tôi luôn sẵn sàng kết nối, trao đổi ý tưởng và đón nhận những cơ hội hợp tác mới.',
    ...
    en: {
        ...
        'about.desc': 'My learning journey, technical skill evolution, and core working principles.',
        ...
        'experience.desc': 'Academic milestones, specialized AI training bootcamps, and corporate internships.',

        // Skills
        'skills.title': 'Technical Skills',
        'skills.title.part1': 'Technical',
        'skills.title.part2': 'Skills',
        'skills.desc': 'Core technical stack spanning Frontend, Backend, Databases, AI & DevOps.',
        'skills.html': 'Html5, Css & Javascript',
        ...
        'projects.desc': 'Selected software engineering projects and AI-driven solutions built for real-world impact.',
        'projects.code': 'Code',
        'projects.demo': 'Demo',
        ...
        'contact.desc': 'Always open for new opportunities, engineering collaborations, and discussions.',
